...
#t5.selectbox("Choose Option",["Linkedin","Email","Phone No.",])
t5.page_link("https://www.linkedin.com/in/siddharth-patel-108581304/", label="💻Linkedin")
#t5.write("📧patelsiddharth264@gmail.com")
